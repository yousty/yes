...
module Yes
  module Core
    class CommandNotifier
      ...
      # @param cmd_response [Yousty::Eventsourcing::CommandResponse] the command response to notify
      ...
      # @yieldreturn [Array<CommandResponse>] responses from the executed commands
      # @return [Array<CommandResponse>] responses from the executed commands
