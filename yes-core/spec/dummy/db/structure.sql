...
--
-- Name: apprenticeships; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: job_apps; Type: TABLE; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.apprenticeships
    ADD CONSTRAINT apprenticeships_pkey PRIMARY KEY (id);
...
--
-- Name: job_apps job_apps_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_apps
    ADD CONSTRAINT job_apps_pkey PRIMARY KEY (id);
