...
require_relative 'lib/yousty/read/api/version'

Gem::Specification.new do |spec|
  spec.name = 'yousty-read-api'
  spec.version = Yousty::Read::Api::VERSION
  spec.authors = ['Arek Swidrak']
  spec.email = ['arek@useo.pl']

  spec.summary = 'Yousty Read Api'
  spec.description = 'Read API for the Yousty eventsourced microservice architecture.'
  spec.homepage = 'https://github.com/yousty/yousty-read-api'
  spec.license = 'MIT'
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/yousty/yousty-read-api'
  spec.metadata['changelog_uri'] = 'https://github.com/yousty/yousty-read-api/CHANGELOG.md'
